          ...
          playerData ? (
            <div>
              ...
              <div className='flex justify-between items-center mt-1'>
                ...
                <button onClick={()=> markLectureAsCompleted(playerData.lectureId)} className='text-blue-600'>{progressData && progressData.lectureCompleted.includes(playerData.lectureId) ? 'Completed':
