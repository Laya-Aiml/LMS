...
const CourseDetails = () => { 
  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      <div className='absolute top-0 left-0 w-full h-[500px] bg-gradient-to-b from-red-300/35 to-transparent'></div>
      <div className='max-w-xl text-gray-500'>
        <h1 className='-left-6 md:text-[50px] font-semibold text-gray-800'>{courseData.courseTitle}</h1>
      ...
      <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
        ...
        <p className='text-sm'>Course by <span className='text-red-600 underline'>{courseData.educator.name}</span></p>
      ...
      <div className='max-w-424px z-10 shadow-[100px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-tmd:rounded-none
      overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='pt-5'>
          ...
          <button onClick={enrollCourse} className='md:mt-6 mt-4 w-full py-3 rounded bg-red-600
